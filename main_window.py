...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.stack.addWidget(self.features_page)              # 0
        ...
        self.stack.addWidget(self.task_panel)                 # 2
        self.stack.addWidget(ChangelogPage(self))                 # 3
