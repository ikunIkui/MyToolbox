...
MyToolbox 是一个个人效率工具台，把日常电脑上零散的小工具整合到一个窗口里：
...
| `--icon=res/app.ico` | 程序图标（做好图标后加回来） |
...
### Q2: venv\Scripts\activate 报错禁止运行脚本
...
- 作者：ikunIkui
- GitHub：https://github.com/ikunIkui
